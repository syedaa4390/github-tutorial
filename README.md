...
2. Next, locate to the **top right hand corner**, where you’ll find your **_profile_** icon*. Click on the icon, and then click **Settings** when the list of options appear. Settings should be the **second to last option**.
